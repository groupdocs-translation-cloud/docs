...
GroupDocs.Translation Cloud can translate documents in all popular formats while accurately preserving layout, structure, and formatting.
...
Microsoft Word | .DOCX<br />.DOCM<br />.DOC | Microsoft Word 97-2021 and Microsoft 365 Word documents, including macro-enabled documents.
Microsoft Excel | .XLSX<br />.XLSM<br />.XLS | Microsoft Excel 95-2021 and Microsoft 365 Excel workbooks, including macro-enabled workbooks.
...
.DOCM              | .DOCM
.XLSX              | .XLSX<br />.XLSB<br />.HTML<br />.PDF<br />.XPS<br />.ODS<br />.MD<br />.DOCX<br />.PPTX<br />.TIFF
.XLS               | .XLS<br />.XLSX<br />.XLSB<br />.HTML<br />.PDF<br />.XPS<br />.ODS<br />.MD<br />.DOCX<br />.PPTX<br />.TIFF
.ODS               | .XLSX<br />.XLSB<br />.HTML<br />.PDF<br />.XPS<br />.ODS<br />.MD<br />.DOCX<br />.PPTX<br />.TIFF
.CSV               | .XLSX<br />.XLSB<br />.HTML<br />.PDF<br />.XPS<br />.ODS<br />.MD<br />.DOCX<br />.PPTX<br />.TIFF
.TSV               | .XLSX<br />.XLSB<br />.HTML<br />.PDF<br />.XPS<br />.ODS<br />.MD<br />.DOCX<br />.PPTX<br />.TIFF
.XLSM              | .XLSM
