...
type: docs
url: /translation/file/request/markdown/
productName: "GroupDocs.Translation Cloud"
title: Sending Markdown files for translation
description: How to send Markdown files for translation to the selected languages.
keywords:
- translate
- send
- input
...
To translate markdown file, send a **POST** request to the `https://api.groupdocs.cloud/v2.0/translation/markdown` GroupDocs.Translation Cloud REST API endpoint. To authorize the request, pass the [access token](/translation/authorization/) in **Authorization** header (_Bearer_ authentication).
